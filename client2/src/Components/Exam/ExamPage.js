...
import genrand from "../../utils/genrand";
			...
			<React.Fragment>
				<Nav
					...
					user={{
						...
						matno: this.props.location.state.matno,
					}}
								...
								<div className="option_container">
									<div className="form-check">
										...
										<label class="form-check-label" for="exampleRadios1">
											<span style={{ float: "left" }} className="mr-1">
												(A)
											</span>
											{this.checkQuestionType(
												...
												<img
													alt="questionImage"
													src={questions[currentIndex].optionA}
												/>
											) : (
												questions[currentIndex].optionA
											)}
									...
									<div class="form-check">
										...
										<label class="form-check-label" for="exampleRadios2">
											...
											{this.checkQuestionType(
												...
												<img
													alt="questionImage"
													src={questions[currentIndex].optionB}
												/>
											) : (
												questions[currentIndex].optionB
											)}
									...
									<div class="form-check">
										...
										<label class="form-check-label" for="exampleRadios3">
											...
											{this.checkQuestionType(
												...
												<img
													alt="questionImage"
													src={questions[currentIndex].optionC}
												/>
											) : (
												questions[currentIndex].optionC
											)}
									...
									<div class="form-check">
										...
										<label class="form-check-label" for="exampleRadios4">
											...
											{this.checkQuestionType(
												...
												<img
													alt="questionImage"
													src={questions[currentIndex].optionD}
												/>
											) : (
												questions[currentIndex].optionD
											)}
										...
										<div
											onClick={() => {
												this.setState((prevState) => {
													return {
														currentIndex:
															prevState.currentIndex === questions.length - 1
																? 0
																: prevState.currentIndex + 1,
													};
												});
